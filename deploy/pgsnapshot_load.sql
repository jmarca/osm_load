-- Deploy osm_load:pgsnapshot_load to pg
-- requires: pgsnapshot_schema_linestring
-- requires: pgsnapshot_schema_bbox
-- requires: pgsnapshot_schema_action
-- requires: pgsnapshot_schema

BEGIN;

-- Allow data loss (but not corruption) in the case of a power outage. This is okay because we need to re-run the script anyway.
